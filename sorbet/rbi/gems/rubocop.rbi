...
module RuboCop::FileFinder
  ...
  def traverse_directories_upwards(start_dir, stop_dir = nil); end
...
class RuboCop::Cop::Registry
  ...
  def resolve_badge(given_badge, real_badge, source_path, warn: nil); end
  def select(&block); end
  def self.all; end
  def self.global; end
  def self.qualified_cop?(name); end
  def self.qualified_cop_name(name, origin, warn: nil); end
  def self.reset!; end
...
class RuboCop::Cop::Base
  ...
  def self.documentation_url(config = nil); end
...
module RuboCop::Cop::DigHelp
  def dig?(param0 = nil); end
  def dig_chain_enabled?; end
...
module RuboCop::Cop::HashSubset
  def block_with_first_arg_check?(param0 = nil); end
  def decorate_source(value); end
  def except_key(node); end
  def except_key_source(key); end
  def extract_body_if_negated(body); end
  def extract_offense(node); end
  def extracts_hash_subset?(block); end
  def included?(body, negated); end
  def not_included?(body, negated); end
  def offense_range(node); end
  def on_csend(node); end
  def on_send(node); end
  def preferred_method_name; end
  def range_include?(send_node); end
  def safe_to_register_offense?(block, except_key); end
  def semantically_except_method?(node); end
  def semantically_slice_method?(node); end
  def semantically_subset_method?(node); end
  def slices_key?(send_node, method, key_arg, value_arg); end
  def supported_subset_method?(method); end
  def using_value_variable?(send_node, value_arg); end
  extend RuboCop::AST::NodePattern::Macros
  include RuboCop::Cop::RangeHelp
end
...
module RuboCop::Cop::LineLengthHelp
  def allow_qualified_name?; end
  def allow_uri?; end
  def allowed_position?(line, range); end
  def directive_on_source_line?(line_index); end
  def extend_end_position(line, end_position); end
  def find_excessive_range(line, type); end
  ...
  def match_qualified_names(string); end
  def match_uris(string); end
  def qualified_name_regexp; end
...
module RuboCop::Cop::PrecedingFollowingAlignment
  ...
  def aligned_equals_operator?(range, lineno); end
  def aligned_identical?(range, line); end
  def aligned_operator?(range, line, lineno); end
  def aligned_token?(range, line, lineno); end
  ...
  def aligned_with_append_operator?(range, token); end
  def aligned_with_equals_sign(token, line_range); end
  def aligned_with_line?(line_nos, range, indent = nil); end
  def aligned_with_operator?(range); end
  def aligned_with_preceding_equals?(range, token); end
  def aligned_with_preceding_equals_operator(token); end
  def aligned_with_something?(range); end
  def aligned_with_subsequent_equals_operator(token); end
...
module RuboCop::Cop::StatementModifier
  ...
  def omitted_value_in_last_hash_arg?(if_body); end
...
class RuboCop::Cop::Gemspec::AttributeAssignment < RuboCop::Cop::Base
  def on_new_investigation; end
  def source_assignments(ast); end
  def source_indexed_assignments(ast); end
...
class RuboCop::Cop::Layout::EmptyLinesAroundAccessModifier < RuboCop::Cop::Base
  ...
  def next_line_empty_and_exists?(last_send_line); end
  def no_empty_lines_around_block_body?; end
  def on_block(node); end
  def on_class(node); end
  def on_itblock(node); end
  def on_module(node); end
  ...
  def should_insert_line_after?(node); end
  def should_insert_line_before?(node); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::ConfigurableEnforcedStyle
  include RuboCop::Cop::RangeHelp
end
...
class RuboCop::Cop::Layout::EmptyLinesAroundMethodBody < RuboCop::Cop::Base
  def offending_endless_method?(node); end
  def on_def(node); end
  def on_defs(node); end
  def register_offense_for_endless_method(node); end
  def style; end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::Layout::EmptyLinesAroundBody
end
...
class RuboCop::Cop::Layout::LeadingCommentSpace < RuboCop::Cop::Base
  ...
  def shebang_continuation?(comment); end
...
class RuboCop::Cop::Layout::SpaceAfterSemicolon < RuboCop::Cop::Base
  def kind(token); end
  def semicolon_sequence?(token, next_token); end
  def space_missing?(token1, token2); end
  def space_style_before_rcurly; end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::SpaceAfterPunctuation
...
class RuboCop::Cop::Layout::SpaceInsideArrayLiteralBrackets < RuboCop::Cop::Base
  ...
  def find_node_with_brackets(node); end
...
class RuboCop::Cop::Lint::ArrayLiteralInRegexp < RuboCop::Cop::Base
  def alternation_for(values); end
  def array_of_literal_values?(node); end
  def array_values(node); end
  def character_class?(values); end
  def character_class_for(values); end
  def escape_values(values); end
  def on_interpolation(begin_node); end
  def register_array_of_literal_values(begin_node, node); end
  def register_array_of_nonliteral_values(node); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::Interpolation
end
...
class RuboCop::Cop::Lint::ConstantReassignment < RuboCop::Cop::Base
  def ancestor_namespaces(node); end
  def constant_names; end
  def constant_namespaces(node); end
  def fixed_constant_path?(node); end
  def freeze_method?(node); end
  def fully_qualified_constant_name(node); end
  def fully_qualified_name_for(namespaces, constant); end
  def on_casgn(node); end
  def on_send(node); end
  def remove_constant(param0 = nil); end
...
class RuboCop::Cop::Lint::DuplicateMethods < RuboCop::Cop::Base
  ...
  def delegate_method?(param0 = nil); end
...
class RuboCop::Cop::Lint::DuplicateSetElement < RuboCop::Cop::Base
  def on_csend(node); end
  def on_send(node); end
  def register_offense(current_element, prev_element, node); end
  def set_init_elements(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Lint::SharedMutableDefault < RuboCop::Cop::Base
  def capacity_keyword_argument?(param0 = nil); end
  def hash_initialized_with_mutable_shared_object?(param0 = nil); end
  def on_send(node); end
end
...
class RuboCop::Cop::Lint::FloatComparison < RuboCop::Cop::Base
  def float?(node); end
  def float_send?(node); end
  def literal_safe?(node); end
  def numeric_returning_method?(node); end
  def on_case(node); end
  def on_csend(node); end
  def on_send(node); end
end
...
class RuboCop::Cop::Lint::IdentityComparison < RuboCop::Cop::Base
  def object_id_comparison(param0 = nil); end
  def on_send(node); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Lint::NestedMethodDefinition < RuboCop::Cop::Base
  ...
  def allowed_subject_type?(subject); end
...
class RuboCop::Cop::Lint::NumericOperationWithConstantResult < RuboCop::Cop::Base
  def abbreviated_assignment_with_constant_result?(param0 = nil); end
  def constant_result?(lhs, operation, rhs); end
  def on_csend(node); end
  def on_op_asgn(node); end
  def on_send(node); end
  def operation_with_constant_result?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Lint::RedundantTypeConversion < RuboCop::Cop::Base
  def array_constructor?(param0 = nil); end
  def bigdecimal_constructor?(param0 = nil); end
  def chained_conversion?(node, receiver); end
  def chained_to_typed_method?(node, receiver); end
  def complex_constructor?(param0 = nil); end
  def constructor?(node, receiver); end
  def constructor_suppresses_exceptions?(receiver); end
  def exception_false_keyword_argument?(param0 = nil); end
  def find_receiver(node); end
  def float_constructor?(param0 = nil); end
  def hash_constructor?(param0 = nil); end
  def hash_or_set_with_block?(node); end
  def integer_constructor?(param0 = nil); end
  def literal_receiver?(node, receiver); end
  def on_csend(node); end
  def on_send(node); end
  def rational_constructor?(param0 = nil); end
  def set_constructor?(param0 = nil); end
  def string_constructor?(param0 = nil); end
  def type_constructor?(param0 = nil, param1); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Lint::SafeNavigationChain < RuboCop::Cop::Base
  ...
  def on_send(node); end
  def operator_inside_collection_literal?(send_node); end
...
class RuboCop::Cop::Lint::ShadowingOuterLocalVariable < RuboCop::Cop::Base
  ...
  def variable_used_in_declaration_of_outer?(variable, outer_local_variable); end
end
...
class RuboCop::Cop::Lint::SuppressedExceptionInNumberConversion < RuboCop::Cop::Base
  def begin_numeric_constructor_rescue_nil(param0 = nil); end
  def constructor_receiver?(param0 = nil); end
  def expected_exception_classes_only?(exception_classes); end
  def numeric_constructor_rescue_nil(param0 = nil); end
  def numeric_method?(param0 = nil); end
  def on_rescue(node); end
  extend RuboCop::Cop::AutoCorrector
  extend RuboCop::Cop::TargetRubyVersion
end
...
class RuboCop::Cop::Lint::UriRegexp < RuboCop::Cop::Base
  def on_send(node); end
  def uri_constant?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Lint::UselessConstantScoping < RuboCop::Cop::Base
  def after_private_modifier?(left_siblings); end
  def on_casgn(node); end
  def private_constantize?(right_siblings, const_value); end
  def private_constants(param0 = nil); end
end
class RuboCop::Cop::Lint::UselessDefaultValueArgument < RuboCop::Cop::Base
  def default_value_argument_and_block(param0 = nil); end
...
class RuboCop::Cop::Lint::UselessNumericOperation < RuboCop::Cop::Base
  ...
  def useless_abbreviated_assignment?(param0 = nil); end
  def useless_operation?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
end
class RuboCop::Cop::Lint::UselessOr < RuboCop::Cop::Base
  def on_or(node); end
  def report_offense(or_node, truthy_node); end
  def truthy_return_value_method?(param0 = nil); end
end
...
class RuboCop::Cop::Metrics::ClassLength < RuboCop::Cop::Base
  def find_expression_within_parent(parent); end
  def message(length, max_length); end
  def on_casgn(node); end
  def on_class(node); end
  def on_sclass(node); end
...
class RuboCop::Cop::Metrics::CollectionLiteralLength < RuboCop::Cop::Base
  ...
  def on_index(node); end
  def on_send(node); end
  def set_const?(param0 = nil); end
end
class RuboCop::Cop::Metrics::MethodLength < RuboCop::Cop::Base
  def allowed?(method_name); end
  def cop_label; end
  def on_block(node); end
  def on_def(node); end
  def on_defs(node); end
...
class RuboCop::Cop::Naming::FileName < RuboCop::Cop::Base
  ...
  def namespace_matches?(node, namespace, expected); end
...
class RuboCop::Cop::Naming::MethodName < RuboCop::Cop::Base
  ...
  def register_forbidden_name(node); end
...
class RuboCop::Cop::Naming::PredicateMethod < RuboCop::Cop::Base
  def acceptable?(return_values); end
  def all_return_values_boolean?(return_values); end
  def allow_bang_methods?; end
  def allowed?(node); end
  def allowed_bang_method?(node); end
  def and_or?(node); end
  def boolean_return?(value); end
  def conservative?; end
  def extract_and_or_clauses(node); end
  def extract_conditional_branches(node); end
  def extract_return_value(node); end
  def last_value(node); end
  def on_def(node); end
  def on_defs(node); end
  def potential_non_predicate?(return_values); end
  def process_return_values(return_values); end
  def return_values(node); end
  def unknown_method_call?(value); end
  include RuboCop::Cop::AllowedMethods
  include RuboCop::Cop::AllowedPattern
end
class RuboCop::Cop::Naming::PredicatePrefix < RuboCop::Cop::Base
  ...
  def method_definition_macro?(macro_name); end
  def on_def(node); end
  def on_defs(node); end
  def on_send(node); end
  def predicate_prefixes; end
  def sorbet_return_type(param0 = nil); end
  def sorbet_sig?(node, return_type: nil); end
  def use_sorbet_sigs?; end
  def validate_config; end
  include RuboCop::Cop::AllowedMethods
end
...
class RuboCop::Cop::Style::AccessModifierDeclarations < RuboCop::Cop::Base
  ...
  def access_modifier_with_alias_method?(param0 = nil); end
  def access_modifier_with_attr?(param0 = nil); end
...
class RuboCop::Cop::Style::AccessorGrouping < RuboCop::Cop::Base
  ...
  def groupable_sibling_accessor?(node, sibling); end
  ...
  def skip_for_grouping?(node); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::ConfigurableEnforcedStyle
  include RuboCop::Cop::RangeHelp
  include RuboCop::Cop::VisibilityHelp
...
class RuboCop::Cop::Style::AmbiguousEndlessMethodDefinition < RuboCop::Cop::Base
  def ambiguous_endless_method_body(param0 = nil); end
...
class RuboCop::Cop::Style::ArgumentsForwarding < RuboCop::Cop::Base
  ...
  def all_forwarding_offenses_correctable?(send_classifications); end
  def allow_anonymous_forwarding_in_block?(node); end
...
class RuboCop::Cop::Style::ArgumentsForwarding::SendNodeClassifier
  ...
  def def_all_anonymous_args?(param0 = nil); end
  ...
  def send_all_anonymous_args?(param0 = nil); end
  def target_ruby_version; end
  extend RuboCop::AST::NodePattern::Macros
end
...
class RuboCop::Cop::Style::BitwisePredicate < RuboCop::Cop::Base
  def allbits?(param0 = nil); end
  def anybits?(param0 = nil); end
  def bit_operation?(param0 = nil); end
  def nobits?(param0 = nil); end
  def on_send(node); end
  def preferred_method(node); end
  extend RuboCop::Cop::AutoCorrector
  extend RuboCop::Cop::TargetRubyVersion
...
class RuboCop::Cop::Style::BlockDelimiters < RuboCop::Cop::Base
  ...
  def single_argument_operator_method?(node); end
...
class RuboCop::Cop::Style::ClassAndModuleChildren < RuboCop::Cop::Base
  ...
  def check_style(node, body, style); end
  ...
  def spaces_size(spaces_string); end
  def split_on_double_colon(corrector, node, padding); end
  def style_for_classes; end
  def style_for_modules; end
  def tab_indentation_width; end
...
class RuboCop::Cop::Style::CollectionQuerying < RuboCop::Cop::Base
  def count_predicate(param0 = nil); end
  def on_send(node); end
  def removal_range(node); end
  def replacement_method(node); end
  def replacement_supported?(method_name); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::RangeHelp
end
...
class RuboCop::Cop::Style::ComparableBetween < RuboCop::Cop::Base
  def logical_comparison_between_by_max_first?(param0 = nil); end
  def logical_comparison_between_by_min_first?(param0 = nil); end
  def on_and(node); end
...
class RuboCop::Cop::Style::DefWithParentheses < RuboCop::Cop::Base
  def on_def(node); end
  def on_defs(node); end
  def parentheses_required?(node, arguments_range); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::RangeHelp
end
class RuboCop::Cop::Style::DigChain < RuboCop::Cop::Base
  def inspect_chain(node); end
  def invalid_arguments?(arguments); end
  def on_csend(node); end
  def on_send(node); end
  def register_offense(node, range, arguments); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::CommentsHelp
...
class RuboCop::Cop::Style::EmptyLiteral < RuboCop::Cop::Base
  ...
  def array_with_index(param0 = nil); end
  ...
  def hash_with_index(param0 = nil); end
...
class RuboCop::Cop::Style::EmptyStringInsideInterpolation < RuboCop::Cop::Base
  def empty_branch_outcome?(branch); end
  def empty_else_outcome?(node); end
  def empty_if_outcome?(node); end
  def on_interpolation(node); end
  def ternary_style_autocorrect(node, outcome, condition); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::ConfigurableEnforcedStyle
  include RuboCop::Cop::Interpolation
end
...
class RuboCop::Cop::Style::FloatDivision < RuboCop::Cop::Base
  ...
  def to_f_method?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::ConfigurableEnforcedStyle
end
...
class RuboCop::Cop::Style::FormatStringToken < RuboCop::Cop::Base
  def allowed_string?(node, detected_style); end
...
class RuboCop::Cop::Style::HashEachMethods < RuboCop::Cop::Base
  ...
  def hash_mutated?(param0 = nil, param1); end
...
class RuboCop::Cop::Style::HashFetchChain < RuboCop::Cop::Base
  def diggable?(param0 = nil); end
  def inspect_chain(node); end
  def last_fetch_non_nil?(node); end
  def on_csend(node); end
  def on_send(node); end
  def replacement(arguments); end
  extend RuboCop::Cop::AutoCorrector
  extend RuboCop::Cop::TargetRubyVersion
end
...
class RuboCop::Cop::Style::IfUnlessModifier < RuboCop::Cop::Base
  ...
  def too_long_line_based_on_allow_qualified_name?(line); end
...
class RuboCop::Cop::Style::IfWithSemicolon < RuboCop::Cop::Base
  ...
  def require_newline?(node); end
  def use_masgn_or_block_in_branches?(node); end
  def use_return_with_argument?(node); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::OnNormalIfUnless
end
...
class RuboCop::Cop::Style::ItBlockParameter < RuboCop::Cop::Base
  def find_block_variables(node, block_argument_name); end
  def on_block(node); end
  def on_itblock(node); end
  def on_numblock(node); end
  extend RuboCop::Cop::AutoCorrector
...
class RuboCop::Cop::Style::KeywordArgumentsMerging < RuboCop::Cop::Base
  ...
  def merge_kwargs?(param0 = nil); end
  def on_kwsplat(node); end
  extend RuboCop::Cop::AutoCorrector
end
class RuboCop::Cop::Style::KeywordParametersOrder < RuboCop::Cop::Base
  ...
  def autocorrect(corrector, node, defining_node, kwarg_nodes); end
  def on_kwoptarg(node); end
...
class RuboCop::Cop::Style::LineEndConcatenation < RuboCop::Cop::Base
  ...
  def on_new_investigation; end
  def register_offense(operator); end
  def self.autocorrect_incompatible_with; end
...
class RuboCop::Cop::Style::MapIntoArray < RuboCop::Cop::Base
  ...
  def each_block_with_push?(param0 = nil); end
  def empty_array_asgn?(param0 = nil); end
  def empty_array_tap(param0 = nil); end
  def find_closest_assignment(block, dest_var); end
  def find_dest_var(block); end
  def lvar_ref?(param0 = nil, param1); end
  def new_method_name; end
...
module RuboCop::Cop::Style::MethodCallWithArgsParentheses::OmitParentheses
  ...
  def ambiguous_range_argument?(node); end
...
class RuboCop::Cop::Style::MinMaxComparison < RuboCop::Cop::Base
  ...
  def comparison_condition(param0 = nil); end
  def on_if(node); end
...
class RuboCop::Cop::Style::RedundantArrayFlatten < RuboCop::Cop::Base
  def flatten_join?(param0 = nil); end
  def on_csend(node); end
  def on_send(node); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Style::RedundantFormat < RuboCop::Cop::Base
  def all_fields_literal?(string, arguments); end
  def argument_value(argument); end
  def argument_values(arguments); end
  def complex_number?(param0 = nil); end
  def complex_value(complex_node); end
  def detect_unnecessary_fields(node); end
  def dsym_value(dsym_node); end
  def find_argument(sequence, arguments, hash); end
  def find_hash_value_node(param0, param1); end
  def float?(argument); end
  def format_without_additional_args?(param0 = nil); end
  def hash_value(hash_node); end
  def integer?(argument); end
  def matching_argument?(sequence, argument); end
  def message(node, prefer); end
  def numeric?(argument); end
  def on_send(node); end
  def quote(string, node); end
  def rational_number?(param0 = nil); end
  def rational_value(rational_node); end
  def register_all_fields_literal(node, string, arguments); end
  def splatted_arguments?(param0 = nil); end
  extend RuboCop::Cop::AutoCorrector
end
...
class RuboCop::Cop::Style::RedundantLineContinuation < RuboCop::Cop::Base
  ...
  def code_ends_with_continuation?(last_line); end
  def ends_with_uncommented_backslash?(range); end
...
class RuboCop::Cop::Style::RedundantSelfAssignment < RuboCop::Cop::Base
  ...
  def redundant_self_assignment?(param0 = nil, param1, param2); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::RangeHelp
end
...
class RuboCop::Cop::Style::SingleLineDoEndBlock < RuboCop::Cop::Base
  ...
  def on_itblock(node); end
  def on_numblock(node); end
  def single_line_blocks_preferred?; end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::CheckSingleLineSuitability
end
class RuboCop::Cop::Style::SoleNestedConditional < RuboCop::Cop::Base
  def add_parentheses?(node); end
  def add_parentheses_if_needed(condition); end
  ...
  def chainable_condition(node); end
  def correct_for_basic_condition_style(corrector, node, if_branch); end
  def correct_for_comment(corrector, node, if_branch); end
  def correct_for_guard_condition_style(corrector, node, if_branch); end
  def correct_node(corrector, node); end
...
class RuboCop::Cop::Style::MapCompactWithConditionalBlock < RuboCop::Cop::Base
  def conditional_block(param0 = nil); end
...
class RuboCop::Cop::Style::MultipleComparison < RuboCop::Cop::Base
  ...
  def find_offending_var(node, variables = nil, values = nil); end
  def nested_comparison?(node); end
  def offense_range(values); end
  def on_or(node); end
...
class RuboCop::Cop::Style::Next < RuboCop::Cop::Base
  ...
  def consecutive_conditionals?(if_node); end
...
class RuboCop::Cop::Style::RedundantCondition < RuboCop::Cop::Base
  ...
  def if_branch_is_true_type_and_else_is_not?(node); end
  ...
  def wrap_arguments_with_parens(condition); end
  extend RuboCop::Cop::AutoCorrector
  include RuboCop::Cop::AllowedMethods
  include RuboCop::Cop::CommentsHelp
  include RuboCop::Cop::RangeHelp
...
class RuboCop::Cop::Style::RedundantSortBy < RuboCop::Cop::Base
  ...
  def redundant_sort_by_itblock(param0 = nil); end
...
class RuboCop::Cop::Style::SafeNavigation < RuboCop::Cop::Base
  ...
  def and_inside_begin?(param0 = nil); end
  def and_parts(node); end
  def and_with_rhs_or?(param0 = nil); end
  ...
  def report_offense(node, rhs, rhs_receiver, *removal_ranges, offense_range: nil); end
  def strip_begin(param0 = nil); end
...
class RuboCop::Cop::Style::SlicingWithRange < RuboCop::Cop::Base
  def arguments_source(node); end
  def beginless(range_node); end
  def endless(range_node); end
  def find_offense_range(node); end
  def offense_message_for_partial_range(node, prefer, offense_range); end
  def offense_message_with_removal_range(node, range_node, offense_range); end
  def on_csend(node); end
  def on_send(node); end
  ...
  def unparenthesized_call?(node); end
  extend RuboCop::Cop::AutoCorrector
  extend RuboCop::Cop::TargetRubyVersion
end
...
class RuboCop::Cop::Style::SuperArguments < RuboCop::Cop::Base
  def argument_list_size_differs?(def_args, super_args, super_node); end
  def arguments_identical?(def_node, super_node, def_args, super_args); end
  def block_arg_same?(def_node, super_node, def_arg, super_arg); end
  def block_reassigned?(def_node, block_arg_name); end
  def block_sends_to_super?(super_node, parent_node = nil); end
  def find_def_node(super_node); end
...
class RuboCop::Cop::Style::ZeroLengthPredicate < RuboCop::Cop::Base
  ...
  def on_csend(node); end
  def on_send(node); end
  def other_length_node(param0 = nil); end
  def replacement(node); end
  def zero_length_comparison(param0 = nil); end
  def zero_length_node(param0 = nil); end
...
class RuboCop::Plugin::ConfigurationIntegrator
  def self.combine_rubocop_configs(default_config, runner_context, plugins); end
  def self.create_context(rubocop_config); end
  def self.fake_out_rubocop_default_configuration(default_config); end
  def self.integrate_plugins_into_rubocop_config(rubocop_config, plugins); end
  def self.load_plugin_rubocop_config(plugin, runner_context); end
  def self.merge_all_cop_settings(existing_all_cops, new_all_cops, already_configured_keys); end
  def self.merge_plugin_config_into_all_cops!(rubocop_config, plugin_config); end
  def self.merge_plugin_config_into_default_config!(default_config, plugin_config); end
  def self.resolver; end
  def self.validate_plugins!(plugins, runner_context); end
end
...
class RuboCop::Plugin::Loader
  def self.constantize(plugin_name, plugin_config); end
  def self.constantize_plugin_from(plugin_name, plugin_config); end
  def self.constantize_plugin_from_gemspec_metadata(plugin_name); end
  def self.load(plugins); end
  def self.normalize(plugin_configs); end
  def self.require_plugin(require_path); end
end
...
class RuboCop::ConfigFinder
  ...
  def self.find_project_root_dot_config; end
...
class RuboCop::ConfigLoader
  ...
  def self.yaml_tree_to_hash!(yaml_tree); end
  def self.yaml_tree_to_hash(yaml_tree); end
end
...
class RuboCop::Lockfile
  ...
  def gem_versions(include_transitive_dependencies: nil); end
  def gems; end
  def includes_gem?(name); end
  def initialize(lockfile_path = nil); end
  def parser; end
...
class RuboCop::ResultCache
  ...
  def initialize(file, team, options, config_store, cache_root_override = nil); end
  def load; end
  def path; end
  ...
  def self.cache_root(config_store, cache_root_override = nil); end
  def self.cleanup(config_store, verbose, cache_root_override = nil); end
  def self.inhibit_cleanup; end
  def self.inhibit_cleanup=(arg0); end
  def self.remove_files(files, dirs, remove_count); end
  def self.remove_oldest_files(files, dirs, rubocop_cache_dir, verbose); end
