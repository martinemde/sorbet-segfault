...
class YARDSorbet::Handlers::SigHandler < ::YARD::Handlers::Ruby::Base
  ...
  sig { params(attach_to: T.any(::YARD::CodeObjects::MethodObject, ::YARD::Parser::Ruby::MethodCallNode, ::YARD::Parser::Ruby::MethodDefinitionNode), docstring: T.nilable(::String), include_params: T::Boolean).void }
