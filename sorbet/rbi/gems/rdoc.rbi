...
class RDoc::Options
  ...
  def autolink_excluded_words=(arg0); end
  def canonical_root; end
  def canonical_root=(arg0); end
  def charset; end
  def charset=(arg0); end
  def check_files; end
  def check_generator; end
  def class_module_path_prefix; end
  def class_module_path_prefix=(arg0); end
  ...
  def warn_missing_rdoc_ref=(arg0); end
  def webcvs; end
  def webcvs=(arg0); end
