...
module Spoom::Context::FileSystem
  ...
  sig { params(allow_extensions: T::Array[::String], allow_mime_types: T::Array[::String], exclude_patterns: T::Array[::String]).returns(T::Array[::String]) }
...
module Spoom::Context::Sorbet
  ...
  sig { params(strictness: ::String, with_config: T.nilable(::Spoom::Sorbet::Config), include_rbis: T::Boolean).returns(T::Array[::String]) }
  ...
  sig { params(arg: ::String, sorbet_bin: T.nilable(::String), capture_err: T::Boolean).returns(T.nilable(T::Hash[::String, ::Integer])) }
...
module Spoom::Coverage
  class << self
    ...
    sig { params(context: ::Spoom::Context, snapshots: T::Array[::Spoom::Coverage::Snapshot], palette: ::Spoom::Coverage::D3::ColorPalette).returns(::Spoom::Coverage::Report) }
    def report(context, snapshots, palette:); end

    # source://spoom//lib/spoom/coverage.rb#14
    sig { params(context: ::Spoom::Context, rbi: T::Boolean, sorbet_bin: T.nilable(::String)).returns(::Spoom::Coverage::Snapshot) }
...
class Spoom::Coverage::Cards::Map < ::Spoom::Coverage::Cards::Card
  ...
  sig { params(file_tree: ::Spoom::FileTree, nodes_strictnesses: T::Hash[::Spoom::FileTree::Node, T.nilable(::String)], nodes_strictness_scores: T::Hash[::Spoom::FileTree::Node, ::Float], title: ::String).void }
...
class Spoom::Coverage::D3::CircleMap::Sigils < ::Spoom::Coverage::D3::CircleMap
  ...
  sig { params(id: ::String, file_tree: ::Spoom::FileTree, nodes_strictnesses: T::Hash[::Spoom::FileTree::Node, T.nilable(::String)], nodes_scores: T::Hash[::Spoom::FileTree::Node, ::Float]).void }
...
class Spoom::Deadcode::Indexer < ::Spoom::Visitor
  ...
  sig { params(path: ::String, index: ::Spoom::Deadcode::Index, plugins: T::Array[::Spoom::Deadcode::Plugins::Base]).void }
...
class Spoom::Deadcode::Plugins::Base
  ...
  class << self
    ...
    sig { params(names: T::Array[T.any(::Regexp, ::String)], names_variable: ::Symbol, patterns_variable: ::Symbol).void }
...
class Spoom::Deadcode::Remover::NodeContext
  ...
  sig { params(source: ::String, comments: T::Hash[::Integer, ::Prism::Comment], node: ::Prism::Node, nesting: T::Array[::Prism::Node]).void }
...
class Spoom::Deadcode::Remover::NodeFinder < ::Spoom::Visitor
  ...
  class << self
    ...
    sig { params(source: ::String, location: ::Spoom::Location, kind: T.nilable(::Spoom::Deadcode::Definition::Kind)).returns(::Spoom::Deadcode::Remover::NodeContext) }
...
class Spoom::Deadcode::Remover::NodeRemover
  ...
  sig { params(source: ::String, kind: T.nilable(::Spoom::Deadcode::Definition::Kind), location: ::Spoom::Location).void }
  ...
  sig { params(node: ::Prism::Node, send_context: ::Spoom::Deadcode::Remover::NodeContext, was_removed: T::Boolean).void }
  ...
  sig { params(node: ::Prism::CallNode, name: ::String, kind: T.nilable(::Spoom::Deadcode::Definition::Kind)).returns(::String) }
...
class Spoom::Deadcode::Send < ::T::Struct
  ...
  sig { type_parameters(:T).params(arg_type: T::Class[T.type_parameter(:T)], block: T.proc.params(arg: T.type_parameter(:T)).void).void }
...
class Spoom::FileCollector
  ...
  sig { params(allow_extensions: T::Array[::String], allow_mime_types: T::Array[::String], exclude_patterns: T::Array[::String]).void }
...
class Spoom::FileTree::Printer < ::Spoom::FileTree::Visitor
  ...
  sig { params(strictnesses: T::Hash[::Spoom::FileTree::Node, T.nilable(::String)], out: T.any(::IO, ::StringIO), colors: T::Boolean).void }
...
class Spoom::Location
  ...
  sig { params(file: ::String, start_line: T.nilable(::Integer), start_column: T.nilable(::Integer), end_line: T.nilable(::Integer), end_column: T.nilable(::Integer)).void }
...
class Spoom::Model::Class < ::Spoom::Model::Namespace
  ...
  sig { params(symbol: ::Spoom::Model::Symbol, owner: T.nilable(::Spoom::Model::Namespace), location: ::Spoom::Location, superclass_name: T.nilable(::String), comments: T::Array[::Spoom::Model::Comment]).void }
...
class Spoom::Model::Constant < ::Spoom::Model::SymbolDef
  ...
  sig { params(symbol: ::Spoom::Model::Symbol, owner: T.nilable(::Spoom::Model::Namespace), location: ::Spoom::Location, value: ::String, comments: T::Array[::Spoom::Model::Comment]).void }
...
class Spoom::Model::Namespace < ::Spoom::Model::SymbolDef
  ...
  sig { params(symbol: ::Spoom::Model::Symbol, owner: T.nilable(::Spoom::Model::Namespace), location: ::Spoom::Location, comments: T::Array[::Spoom::Model::Comment]).void }
...
class Spoom::Model::Property < ::Spoom::Model::SymbolDef
  ...
  sig { params(symbol: ::Spoom::Model::Symbol, owner: T.nilable(::Spoom::Model::Namespace), location: ::Spoom::Location, visibility: ::Spoom::Model::Visibility, sigs: T::Array[::Spoom::Model::Sig], comments: T::Array[::Spoom::Model::Comment]).void }
...
class Spoom::Sorbet::Metrics::CodeMetricsVisitor < ::Spoom::Visitor
  ...
  sig { params(node: T.any(::Prism::ClassNode, ::Prism::ModuleNode, ::Prism::SingletonClassNode), block: T.proc.void).void }
...
module Spoom::Sorbet::Translate
  class << self
    ...
    sig { params(ruby_contents: ::String, file: ::String, translate_t_let: T::Boolean, translate_t_cast: T::Boolean, translate_t_bind: T::Boolean, translate_t_must: T::Boolean, translate_t_unsafe: T::Boolean).returns(::String) }
    ...
    sig { params(ruby_contents: ::String, file: ::String, positional_names: T::Boolean, max_line_length: T.nilable(::Integer), translate_generics: T::Boolean, translate_helpers: T::Boolean, translate_abstract_methods: T::Boolean).returns(::String) }
...
class Spoom::Sorbet::Translate::RBSCommentsToSorbetSigs < ::Spoom::Sorbet::Translate::Translator
  ...
  sig { params(node: T.any(::Prism::ClassNode, ::Prism::ModuleNode, ::Prism::SingletonClassNode), constant_regex: ::Regexp).returns(T::Boolean) }
...
class Spoom::Sorbet::Translate::SorbetAssertionsToRBSComments < ::Spoom::Sorbet::Translate::Translator
  ...
  sig { params(ruby_contents: ::String, file: ::String, translate_t_let: T::Boolean, translate_t_cast: T::Boolean, translate_t_bind: T::Boolean, translate_t_must: T::Boolean, translate_t_unsafe: T::Boolean).void }
...
class Spoom::Sorbet::Translate::SorbetSigsToRBSComments < ::Spoom::Sorbet::Translate::Translator
  ...
  sig { params(ruby_contents: ::String, file: ::String, positional_names: T::Boolean, max_line_length: T.nilable(::Integer), translate_generics: T::Boolean, translate_helpers: T::Boolean, translate_abstract_methods: T::Boolean).void }
  ...
  sig { params(parent: T.any(::Prism::ClassNode, ::Prism::ModuleNode, ::Prism::SingletonClassNode), node: ::Prism::CallNode).void }
