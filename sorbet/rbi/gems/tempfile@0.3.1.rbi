...
# mutex.
#
# source://tempfile//lib/tempfile.rb#157
class Tempfile
  ...
  #
  # source://tempfile//lib/tempfile.rb#219
  ...
  #
  # source://tempfile//lib/tempfile.rb#279
  def close(unlink_now = T.unsafe(nil)); end

  # Closes and unlinks (deletes) the file. Has the same effect as called
  # <tt>close(true)</tt>.
  #
  # source://tempfile//lib/tempfile.rb#286
  def close!; end
  ...
  #   end
  #
  # source://tempfile//lib/tempfile.rb#337
  def delete; end

  # :stopdoc:
  #
  # source://tempfile//lib/tempfile.rb#357
  def inspect; end

  # Returns the size of the temporary file.  As a side effect, the IO
  # buffer is flushed before determining the size.
  #
  # source://tempfile//lib/tempfile.rb#354
  def length; end

  # Opens or reopens the file with mode "r+".
  #
  # source://tempfile//lib/tempfile.rb#257
  def open; end

  # Returns the full path name of the temporary file.
  # This will be nil if #unlink has been called.
  #
  # source://tempfile//lib/tempfile.rb#341
  def path; end

  # Returns the size of the temporary file.  As a side effect, the IO
  # buffer is flushed before determining the size.
  #
  # source://tempfile//lib/tempfile.rb#347
  def size; end

  # :stopdoc:
  #
  # source://tempfile//lib/tempfile.rb#364
  def to_s; end
  ...
  #   end
  #
  # source://tempfile//lib/tempfile.rb#323
  def unlink; end

  protected

  # source://tempfile//lib/tempfile.rb#268
  def _close; end

  # Returns the value of attribute finalizer_manager.
  #
  # source://tempfile//lib/tempfile.rb#368
  ...
  # source://tempfile//lib/tempfile.rb#243
  def initialize_clone(other); end

  # source://tempfile//lib/tempfile.rb#249
  def initialize_copy_iv(other); end

  # source://tempfile//lib/tempfile.rb#237
  ...
  class << self
    ...
    #
    # source://tempfile//lib/tempfile.rb#558
    def create(basename = T.unsafe(nil), tmpdir = T.unsafe(nil), mode: T.unsafe(nil), anonymous: T.unsafe(nil), **options, &block); end
    ...
    #   end
    #
    # source://tempfile//lib/tempfile.rb#439
    def open(*args, **kw); end

    private

    # source://tempfile//lib/tempfile.rb#606
    def create_anonymous(basename = T.unsafe(nil), tmpdir = T.unsafe(nil), mode: T.unsafe(nil), **options, &block); end

    # source://tempfile//lib/tempfile.rb#567
    def create_with_filename(basename = T.unsafe(nil), tmpdir = T.unsafe(nil), mode: T.unsafe(nil), **options); end
  end
end

# source://tempfile//lib/tempfile.rb#370
class Tempfile::FinalizerManager
  # @return [FinalizerManager] a new instance of FinalizerManager
  #
  # source://tempfile//lib/tempfile.rb#373
  def initialize(path); end

  # source://tempfile//lib/tempfile.rb#386
  def call(object_id); end

  # source://tempfile//lib/tempfile.rb#380
  def register(obj, file); end

  # Returns the value of attribute unlinked.
  #
  # source://tempfile//lib/tempfile.rb#371
  def unlinked; end

  # Sets the attribute unlinked
  #
  # @param value the value to set the attribute unlinked to.
  #
  # source://tempfile//lib/tempfile.rb#371
  def unlinked=(_arg0); end
end

# The version
#
# source://tempfile//lib/tempfile.rb#160
Tempfile::VERSION = T.let(T.unsafe(nil), String)
