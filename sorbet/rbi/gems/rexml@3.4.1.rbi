...
#
# source://rexml//lib/rexml/streamlistener.rb#7
module REXML::StreamListener
  ...
  # methods.
  #
  # source://rexml//lib/rexml/streamlistener.rb#51
  def attlistdecl(element_name, attributes, raw_content); end

  # Called when <![CDATA[ ... ]]> is encountered in a document.
  #
  # source://rexml//lib/rexml/streamlistener.rb#83
  def cdata(content); end

  # Called when a comment is encountered.
  #
  # source://rexml//lib/rexml/streamlistener.rb#33
  def comment(comment); end

  # Handles a doctype declaration. Any attributes of the doctype which are
  # not supplied will be nil.  # EG, <!DOCTYPE me PUBLIC "foo" "bar">
  #
  # source://rexml//lib/rexml/streamlistener.rb#41
  def doctype(name, pub_sys, long_name, uri); end

  # Called when the doctype is done
  #
  # source://rexml//lib/rexml/streamlistener.rb#44
  def doctype_end; end

  # <!ELEMENT ...>
  #
  # source://rexml//lib/rexml/streamlistener.rb#54
  def elementdecl(content); end

  # Called when %foo; is encountered in a doctype declaration.
  #
  # source://rexml//lib/rexml/streamlistener.rb#79
  ...
  #
  # source://rexml//lib/rexml/streamlistener.rb#72
  def entitydecl(content); end

  # Called when an instruction is encountered.  EG: <?xsl sheet='foo'?>
  # "sheet='foo'"
  #
  # source://rexml//lib/rexml/streamlistener.rb#29
  def instruction(name, instruction); end

  # <!NOTATION ...>
  #
  # source://rexml//lib/rexml/streamlistener.rb#75
  def notationdecl(content); end

  # Called when the end tag is reached.  In the case of <tag/>, tag_end
  # will be called immediately after tag_start
  #
  # source://rexml//lib/rexml/streamlistener.rb#19
  ...
  #
  # source://rexml//lib/rexml/streamlistener.rb#14
  def tag_start(name, attrs); end

  # Called when text is encountered in the document
  #
  # source://rexml//lib/rexml/streamlistener.rb#23
  def text(text); end

  # Called when an XML PI is encountered in the document.
  # EG: <?xml version="1.0" encoding="utf"?>
  #
  # source://rexml//lib/rexml/streamlistener.rb#90
