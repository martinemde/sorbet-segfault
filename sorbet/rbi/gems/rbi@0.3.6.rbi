...
class RBI::Attr < ::RBI::NodeWithComments
  ...
  sig { params(name: ::String, sig: T.nilable(::RBI::Sig), visibility: ::RBI::Visibility, loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment]).returns(::RBI::Method) }
  def create_getter_method(name, sig, visibility, loc, comments); end

  # source://rbi//lib/rbi/rewriters/attr_to_methods.rb#92
  sig { params(name: ::String, sig: T.nilable(::RBI::Sig), attribute_type: T.nilable(T.any(::RBI::Type, ::String)), visibility: ::RBI::Visibility, loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment]).returns(::RBI::Method) }
...
class RBI::Formatter
  ...
  sig { params(add_sig_templates: T::Boolean, group_nodes: T::Boolean, max_line_length: T.nilable(::Integer), nest_singleton_methods: T::Boolean, nest_non_public_members: T::Boolean, sort_nodes: T::Boolean, replace_attributes_with_methods: T::Boolean).void }
...
class RBI::Method < ::RBI::NodeWithComments
  ...
  sig { params(params: T::Array[::RBI::SigParam], return_type: T.any(::RBI::Type, ::String), is_abstract: T::Boolean, is_override: T::Boolean, is_overridable: T::Boolean, is_final: T::Boolean, type_params: T::Array[::String], checked: T.nilable(::Symbol), block: T.nilable(T.proc.params(node: ::RBI::Sig).void)).void }
...
class RBI::Parser::TreeBuilder < ::RBI::Parser::Visitor
  ...
  sig { params(node: T.any(::Prism::ConstantPathWriteNode, ::Prism::ConstantWriteNode)).returns(T.nilable(::RBI::Struct)) }
...
class RBI::RBSPrinter < ::RBI::Visitor
  ...
  sig { params(out: T.any(::IO, ::StringIO), indent: ::Integer, print_locs: T::Boolean, positional_names: T::Boolean, max_line_length: T.nilable(::Integer)).void }
...
class RBI::Sig < ::RBI::NodeWithComments
  ...
  sig { params(params: T::Array[::RBI::SigParam], return_type: T.any(::RBI::Type, ::String), is_abstract: T::Boolean, is_override: T::Boolean, is_overridable: T::Boolean, is_final: T::Boolean, allow_incompatible_override: T::Boolean, without_runtime: T::Boolean, type_params: T::Array[::String], checked: T.nilable(::Symbol), loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment], block: T.nilable(T.proc.params(node: ::RBI::Sig).void)).void }
...
class RBI::SigParam < ::RBI::NodeWithComments
  ...
  sig { params(name: ::String, type: T.any(::RBI::Type, ::String), loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment], block: T.nilable(T.proc.params(node: ::RBI::SigParam).void)).void }
...
class RBI::TEnumBlock < ::RBI::Scope
  ...
  sig { params(loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment], block: T.nilable(T.proc.params(node: ::RBI::TEnumBlock).void)).void }
  def initialize(loc: T.unsafe(nil), comments: T.unsafe(nil), &block); end
...
class RBI::TEnumValue < ::RBI::NodeWithComments
  ...
  sig { params(name: ::String, loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment], block: T.nilable(T.proc.params(node: ::RBI::TEnumValue).void)).void }
  def initialize(name, loc: T.unsafe(nil), comments: T.unsafe(nil), &block); end
...
class RBI::TStructConst < ::RBI::TStructField
  ...
  sig { params(name: ::String, type: T.any(::RBI::Type, ::String), default: T.nilable(::String), loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment], block: T.nilable(T.proc.params(node: ::RBI::TStructConst).void)).void }
...
class RBI::TStructField < ::RBI::NodeWithComments
  ...
  sig { params(name: ::String, type: T.any(::RBI::Type, ::String), default: T.nilable(::String), loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment]).void }
...
class RBI::TStructProp < ::RBI::TStructField
  ...
  sig { params(name: ::String, type: T.any(::RBI::Type, ::String), default: T.nilable(::String), loc: T.nilable(::RBI::Loc), comments: T::Array[::RBI::Comment], block: T.nilable(T.proc.params(node: ::RBI::TStructProp).void)).void }
  def initialize(name, type, default: T.unsafe(nil), loc: T.unsafe(nil), comments: T.unsafe(nil), &block); end
