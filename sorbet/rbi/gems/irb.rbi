...
class IRB::Inspector
  ...
  def inspect_value(v, output, colorize: nil); end
...
module IRB::HistorySavingAbility
  def ensure_history_file_writable(history_file); end
...
class IRB::Context
  ...
  def build_type_completor(verbose:); end
  ...
  def inspect; end
  def inspect?; end
  def inspect_last_value(output = nil); end
...
module InvalidName___Class_0x00___SkipPathHelperForIRB_5
...
class IRB::Command::Copy < IRB::Command::Base
  def clipboard_available?; end
  def clipboard_program; end
  def copy_to_clipboard(text); end
  def executable?(command); end
  def execute(arg); end
end
...
class IRB::Pager::PageOverflowIO
  ...
  def initialize(width, height, overflow_callback, delay: nil); end
  def multipage?; end
  def print(text); end
  def puts(text = nil); end
  def string; end
  def write(text); end
end
...
class InvalidName___Class_0x00___Vec_6
  def cross(other); end
  def dot(other); end
...
class InvalidName___Class_0x00___Canvas_7
  def draw; end
  def initialize(arg0); end
  def line(arg0, arg1); end
  def line0(p1, p2); end
end
class InvalidName___Class_0x00___RubyModel_8
