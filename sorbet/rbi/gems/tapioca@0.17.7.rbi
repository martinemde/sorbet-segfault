...
class RBI::Tree < ::RBI::NodeWithComments
  ...
  sig { params(name: ::String, parameters: T::Array[::RBI::TypedParam], return_type: T.nilable(::String), class_method: T::Boolean, visibility: ::RBI::Visibility, comments: T::Array[::RBI::Comment], block: T.nilable(T.proc.params(node: ::RBI::Method).void)).void }
  ...
  sig { params(name: ::String, type: ::String, variance: ::Symbol, fixed: T.nilable(::String), upper: T.nilable(::String), lower: T.nilable(::String)).void }
...
module Tapioca::BundlerExt::AutoRequireHook
  ...
  class << self
    ...
    sig { type_parameters(:Result).params(exclude: T::Array[::String], blk: T.proc.returns(T.type_parameter(:Result))).returns(T.type_parameter(:Result)) }
...
class Tapioca::Commands::Annotations < ::Tapioca::Commands::CommandWithoutTracker
  ...
  sig { params(central_repo_root_uris: T::Array[::String], auth: T.nilable(::String), netrc_file: T.nilable(::String), central_repo_index_path: ::String, typed_overrides: T::Hash[::String, ::String]).void }
...
class Tapioca::Commands::CheckShims < ::Tapioca::Commands::CommandWithoutTracker
  ...
  sig { params(gem_rbi_dir: ::String, dsl_rbi_dir: ::String, annotations_rbi_dir: ::String, shim_rbi_dir: ::String, todo_rbi_file: ::String, payload: T::Boolean, number_of_workers: T.nilable(::Integer)).void }
...
class Tapioca::Commands::GemGenerate < ::Tapioca::Commands::AbstractGem
  ...
  sig { params(gem: ::Tapioca::Gemfile::GemSpec, dependencies: T::Array[::Tapioca::Gemfile::GemSpec]).returns(T::Array[::Tapioca::Gemfile::GemSpec]) }
...
class Tapioca::Dsl::Compiler
  ...
  sig { params(pipeline: ::Tapioca::Dsl::Pipeline, root: ::RBI::Tree, constant: ConstantType, options: T::Hash[::String, T.untyped]).void }
  ...
  class << self
    ...
    sig { type_parameters(:U).params(klass: T.all(T.type_parameter(:U), T::Class[T.anything])).returns(T::Array[T.type_parameter(:U)]) }
...
class Tapioca::Dsl::Pipeline
  ...
  sig { params(requested_constants: T::Array[::Module], requested_paths: T::Array[::Pathname], requested_compilers: T::Array[T.class_of(Tapioca::Dsl::Compiler)], excluded_compilers: T::Array[T.class_of(Tapioca::Dsl::Compiler)], error_handler: T.proc.params(error: ::String).void, skipped_constants: T::Array[::Module], number_of_workers: T.nilable(::Integer), compiler_options: T::Hash[::String, T.untyped], lsp_addon: T::Boolean).void }
  ...
  sig { params(requested_compilers: T::Array[T.class_of(Tapioca::Dsl::Compiler)], excluded_compilers: T::Array[T.class_of(Tapioca::Dsl::Compiler)]).returns(T::Enumerable[T.class_of(Tapioca::Dsl::Compiler)]) }
  def gather_active_compilers(requested_compilers, excluded_compilers); end

  # source://tapioca//lib/tapioca/dsl/pipeline.rb#123
  sig { params(requested_constants: T::Array[::Module], requested_paths: T::Array[::Pathname], skipped_constants: T::Array[::Module]).returns(T::Set[::Module]) }
...
class Tapioca::Gem::Listeners::Methods < ::Tapioca::Gem::Listeners::Base
  ...
  sig { params(tree: ::RBI::Tree, module_name: ::String, mod: ::Module, for_visibility: T::Array[::Symbol], attached_class: T.nilable(::Module)).void }
...
class Tapioca::Gem::Listeners::Mixins < ::Tapioca::Gem::Listeners::Base
  ...
  sig { params(tree: ::RBI::Tree, constant: ::Module, mods: T::Array[::Module], mixin_type: ::Tapioca::Runtime::Trackers::Mixin::Type).void }
  ...
  sig { params(constant: ::Module, mixin: ::Module, mixin_type: ::Tapioca::Runtime::Trackers::Mixin::Type).returns(T::Boolean) }
...
class Tapioca::Gem::MethodNodeAdded < ::Tapioca::Gem::NodeAdded
  ...
  sig { params(symbol: ::String, constant: ::Module, method: ::UnboundMethod, node: ::RBI::Method, signature: T.untyped, parameters: T::Array[[::Symbol, ::String]]).void }
...
class Tapioca::Gem::Pipeline
  ...
  sig { params(gem: ::Tapioca::Gemfile::GemSpec, error_handler: T.proc.params(error: ::String).void, include_doc: T::Boolean, include_loc: T::Boolean).void }
  ...
  sig { params(method_name: ::Symbol, owner: ::Module).returns(::Tapioca::Gem::Pipeline::MethodDefinitionLookupResult) }
...
class Tapioca::Loaders::Dsl < ::Tapioca::Loaders::Loader
  ...
  sig { params(tapioca_path: ::String, eager_load: T::Boolean, app_root: ::String, halt_upon_load_error: T::Boolean).void }
...
class Tapioca::Loaders::Gem < ::Tapioca::Loaders::Loader
  ...
  sig { params(bundle: ::Tapioca::Gemfile, prerequire: T.nilable(::String), postrequire: ::String, default_command: ::String, halt_upon_load_error: T::Boolean).void }
...
class Tapioca::Loaders::Loader
  ...
  sig { params(gemfile: ::Tapioca::Gemfile, initialize_file: T.nilable(::String), require_file: T.nilable(::String), halt_upon_load_error: T::Boolean).void }
  ...
  sig { params(environment_load: T::Boolean, eager_load: T::Boolean, app_root: ::String, halt_upon_load_error: T::Boolean).void }
...
module Tapioca::RBIFilesHelper
  ...
  sig { params(index: ::RBI::Index, shim_rbi_dir: ::String, todo_rbi_file: ::String).returns(T::Hash[::String, T::Array[::RBI::Node]]) }
  ...
  sig { params(command: ::String, gem_dir: ::String, dsl_dir: ::String, auto_strictness: T::Boolean, gems: T::Array[::Tapioca::Gemfile::GemSpec], compilers: T::Enumerable[T.class_of(Tapioca::Dsl::Compiler)]).void }
...
module Tapioca::RBIHelper
  ...
  class << self
    ...
    sig { params(type: ::String, variance: ::Symbol, fixed: T.nilable(::String), upper: T.nilable(::String), lower: T.nilable(::String)).returns(::String) }
...
class Tapioca::SourceURI < ::URI::File
  ...
  class << self
    ...
    sig { params(gem_name: ::String, gem_version: T.nilable(::String), path: ::String, line_number: T.nilable(::String)).returns(T.attached_class) }
